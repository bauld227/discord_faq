...
## Бинды
*0. Для того чтобы открыть возможность получать разные id, в discord нужно включить режим разработчика:
Настройки > Расширенные > Режим разработчика*

1. Есть бинд на ссылку на канал: **[Канал:{id канала}]**
2. Есть бинд на ссылку на канал: **[Пользователь:{id пользователя}]**
